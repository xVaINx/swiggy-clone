    ...
    <SafeAreaView style={styles.container}>
        ...
        <View style={styles.location}>
          ...
          <View style={styles.locationHeading}>
            <Text style={styles.locationSubHeadingText} numberOfLines={1}>
              This is the subheading for location.
            </Text>
          </View>
        </View>
        {/* Profile  */}
      ...
      <View style={{ flexDirection: "row" }}>
        <View style={{ flexDirection: "column", width: "60%" }}>
          <Text style={styles.greetingText}>Say hi to ...</Text>
          <Text style={styles.brandName}>InsanelyGood</Text>
          <Text style={styles.descriptionText}>
            Freshly handmade paneer, stoneground batter & more!
          </Text>
        ...
        <Image
          source={require("../../../assets/paneer.png")} // Make sure to use `source` instead of `src`
          style={{ width: 150, height: 125, resizeMode: "cover" }}
        />
      </View>
      ...
      >
        <View style={{ flexDirection: "column", width: "55%" }}>
          <HomeScreenCards
            ...
            subHeading={"FOOD FIESTA"}
            offer={"UP TO 80% OFF+FREE DEL"}
          ...
          <HomeScreenCards
            ...
            one={0}
            heading={"DINEOUT"}
            subHeading={"GIRF DINING FESTIVAL"}
            offer={"FLAT 50% OFF"}
        ...
        <View style={{ flexDirection: "column", width: "55%" }}>
          <HomeScreenCards
            ...
            offer={"FREE FELIVERY"}
            imageSrc={require("../../../assets/groceries.png")}
            imgHeight={100}
            imgWidth={100}
            dir={1}
            location={"/instamart"}
          ...
          <HomeScreenCards
            cardHeight={80}
            one={0}
            heading={"INSANELYGOOD"}
            subHeading={"QUALITY GROCERY"}
            offer={""}
            imageSrc={""}
            imgHeight={50}
            imgWidth={50}
...
const styles = StyleSheet.create({
  ...
  CardBox: {
    ...
    marginBottom: 10,
    padding: 6,
    width: "80%", // Gives equal space for each card on the row
  ...
  shopNowButton: {
    backgroundColor: "purple", // Change color as needed
    paddingVertical: 5,
    paddingHorizontal: 2,
    borderRadius: 5,
  },
